    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] UserDTO userDto)
        {
            var user = new User
            {
                ...
                FirstName = userDto.FirstName,  // Assign first name
                LastName = userDto.LastName,
                PasswordHash = ""  // PasswordHash will be set inside the Register method
            };
        ...
        {
            var success = await _userService.DeleteAllKorisniciAsync();
